...
namespace DNet.DataAccess
{
    public class SqlBuilder
    {
        ...
        public static SqlConstructor GetInSql(string tableNameOrAlias, string columnName, IEnumerable<int> values,DataBaseType dbType)
        {
            ...
            if (values != null && values.Any())
            {
                ...
                foreach (var v in values)
                {
                    ...
                    result.Parameters.Add(DbParameterFactory.CreateDbParameter(columnName + i.ToString(), v, dbType));
                }
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public static SqlConstructor GetInSql(string tableNameOrAlias, string columnName, IEnumerable<string> values,DataBaseType dbType)
        {
            SqlConstructor result = new SqlConstructor();
            if (values != null && values.Any())
            {
